package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    ...
    '{ OP_LEA, OP_MOVZX, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOVZX, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_ADD, OP_NOP },
    '{ OP_VMOVDQU, OP_VMOVDQU, OP_NOP, OP_NOP },
    '{ OP_VMOVDQU, OP_VMOVDQU, OP_NOP, OP_NOP },
    '{ OP_VMOVQ, OP_VPINSRQ, OP_NOP, OP_NOP },
    '{ OP_VMOVQ, OP_VPINSRQ, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOVZX, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_DEC, OP_IMUL, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_MOV, OP_MOV },
    '{ OP_VMOVSD, OP_VADDSD, OP_VMOVSD, OP_NOP },
    '{ OP_VMOVSD, OP_VADDSD, OP_VMOVSD, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_VMOVDQU, OP_VMOVDQU, OP_NOP, OP_NOP },
    ...
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_CDQE, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOVZX, OP_NOP, OP_NOP },
    '{ OP_MOVSX, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_MOV, OP_NOP }
  };
