package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    '{ OP_MOV, OP_SHR, OP_MOV, OP_NOP },
    '{ OP_IMUL, OP_ADD, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_IMUL, OP_ADD, OP_MOV },
    '{ OP_DEC, OP_SUB, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SAR, OP_NOP, OP_NOP },
    '{ OP_SUB, OP_SAR, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_ADD, OP_SHR },
    '{ OP_MOV, OP_SHR, OP_SUB, OP_NOP },
