...
OPS_MAP = {  
  ...
  "INC":"OP_INC","DEC":"OP_DEC","NEG":"OP_NEG","CMP":"OP_CMP",
  "AND":"OP_AND","OR":"OP_OR","XOR":"OP_XOR","NOT":"OP_NOT","TEST":"OP_TEST",
  "SHL":"OP_SHL","SAL":"OP_SAL","SHR":"OP_SHR","SAR":"OP_SAR",
  "ROL":"OP_ROL","ROR":"OP_ROR","RCL":"OP_RCL","RCR":"OP_RCR",
  "SHLD":"OP_SHLD","SHRD":"OP_SHRD",
...
def make_pkg(blocks) -> str:
    ...
    for idx,b in enumerate(blocks):
        imm=[hex32(i['raw_operands'][1]) if i['opcode'].lower()=="test"
             and len(i['raw_operands'])==2 else "32'h00000000"
    ...
    for idx,b in enumerate(blocks):
        use=["1'b1" if i['opcode'].lower()=="test"
             and len(i['raw_operands'])==2 else "1'b0"
             for i in b['instructions']]
