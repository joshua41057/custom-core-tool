package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    ...
    '{ OP_MOV, OP_AND, OP_NOP, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_MOVSXD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOVSXD, OP_NOP, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_MOVSXD, OP_MOVSXD, OP_NOP, OP_NOP },
    '{ OP_IMUL, OP_ADD, OP_IMUL, OP_ADD, OP_IMUL, OP_ADD },
    '{ OP_MOV, OP_AND, OP_NOP, OP_NOP, OP_NOP, OP_NOP }
  };
  localparam logic [1:0] MEM_KIND_LUT [N_CASE][MAX_LEN] = '{
    '{ 2'd3, 2'd3, 2'd0, 2'd0, 2'd0, 2'd0 },
    '{ 2'd3, 2'd3, 2'd0, 2'd0, 2'd0, 2'd0 },
    '{ 2'd0, 2'd0, 2'd1, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd1, 2'd0, 2'd0, 2'd0, 2'd0 },
    '{ 2'd0, 2'd0, 2'd1, 2'd1, 2'd0, 2'd0 },
    '{ 2'd1, 2'd1, 2'd1, 2'd0, 2'd1, 2'd0 },
    '{ 2'd3, 2'd3, 2'd0, 2'd0, 2'd0, 2'd0 }
  };
