...
module integer_addsub (
  ...
  input CLK;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 add_intf DATA" *)
  (* X_INTERFACE_MODE = "slave add_intf" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME add_intf, LAYERED_METADATA undef" *)
  input ADD;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 c_in_intf DATA" *)
  (* X_INTERFACE_MODE = "slave c_in_intf" *)
  (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME c_in_intf, LAYERED_METADATA undef" *)
  input C_IN;
