...
set hc [get_cells -quiet top_bench__511_povray_r/u_511_povray_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__511_povray_r/u_511_povray_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
