...
resize_pblock $pblk -add {SLICE_X142Y840:SLICE_X166Y899}
set hc [get_cells -quiet top_bench__503_bwaves_r/u_503_bwaves_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__503_bwaves_r/u_503_bwaves_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
