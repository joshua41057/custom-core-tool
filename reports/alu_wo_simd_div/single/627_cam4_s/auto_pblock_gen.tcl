...
set hc [get_cells -quiet top_bench__627_cam4_s/u_627_cam4_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__627_cam4_s/u_627_cam4_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
