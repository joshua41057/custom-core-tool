package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    '{ OP_AND, OP_AND, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_SUB, OP_SUB, OP_MOV },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_MOV, OP_NOP, OP_NOP }
  };
  localparam logic [1:0] MEM_KIND_LUT [N_CASE][MAX_LEN] = '{
    '{ 2'd0, 2'd0, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd1, 2'd0, 2'd0, 2'd3 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd3, 2'd0, 2'd0, 2'd0 },
    '{ 2'd1, 2'd0, 2'd3, 2'd0, 2'd0 }
  };
  ...
  localparam logic [31:0] IMM_LUT [N_CASE][MAX_LEN] = '{
    '{ 32'h0000007f, 32'h000007ff, 32'h00000000, 32'h00000000, 32'h00000000 },
