package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    ...
    '{ OP_MOVSXD, OP_MOV, OP_NOP },
    '{ OP_LEA, OP_ADD, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_INC },
    '{ OP_LEA, OP_MOVSXD, OP_MOV },
    '{ OP_XOR, OP_ADD, OP_NOP },
    '{ OP_MOV, OP_XOR, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP },
  ...
  localparam logic [31:0] IMM_LUT [N_CASE][MAX_LEN] = '{
    ...
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000008, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
