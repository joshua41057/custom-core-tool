package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    ...
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_IMUL, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NEG, OP_CMOVS },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    ...
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_MOVSXD, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_INC, OP_MOVSXD, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_IMUL, OP_NOP, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP, OP_NOP },
    '{ OP_INC, OP_MOVSXD, OP_NOP, OP_NOP },
