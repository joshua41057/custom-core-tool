...
set hc [get_cells -quiet top_bench__644_nab_s/u_644_nab_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__644_nab_s/u_644_nab_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
