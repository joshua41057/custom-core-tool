...
set hc [get_cells -quiet top_bench__619_lbm_s/u_619_lbm_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__619_lbm_s/u_619_lbm_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
