...
resize_pblock $pblk -add {SLICE_X142Y840:SLICE_X168Y899}
set hc [get_cells -quiet top_bench__507_cactuBSSN_r/u_507_cactuBSSN_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__507_cactuBSSN_r/u_507_cactuBSSN_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
