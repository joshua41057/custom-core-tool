...
set hc [get_cells -quiet top_bench__605_mcf_s/u_605_mcf_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__605_mcf_s/u_605_mcf_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
