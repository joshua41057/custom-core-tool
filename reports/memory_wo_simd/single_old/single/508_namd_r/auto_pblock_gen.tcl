...
set hc [get_cells -quiet top_bench__508_namd_r/u_508_namd_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__508_namd_r/u_508_namd_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
