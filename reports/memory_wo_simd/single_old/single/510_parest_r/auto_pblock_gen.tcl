...
set hc [get_cells -quiet top_bench__510_parest_r/u_510_parest_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__510_parest_r/u_510_parest_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
