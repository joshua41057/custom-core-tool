...
set hc [get_cells -quiet top_bench__527_cam4_r/u_527_cam4_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__527_cam4_r/u_527_cam4_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
