...
set hc [get_cells -quiet top_bench__544_nab_r/u_544_nab_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__544_nab_r/u_544_nab_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
