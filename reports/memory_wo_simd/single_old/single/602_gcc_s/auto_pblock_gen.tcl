...
resize_pblock $pblk -add {SLICE_X142Y840:SLICE_X167Y899}
set hc [get_cells -quiet top_bench__602_gcc_s/u_602_gcc_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__602_gcc_s/u_602_gcc_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
