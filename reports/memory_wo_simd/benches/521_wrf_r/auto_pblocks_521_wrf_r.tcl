# pblock for 521.wrf_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_521_wrf_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_521_wrf_r}] }
create_pblock pblock_521_wrf_r
set pblk [get_pblocks -quiet {pblock_521_wrf_r}]
