# pblock for 657.xz_s  CR: X0Y0 .. X1Y2  (sumSLICE=9660, sumSLICEM~4830)
if {[llength [get_pblocks -quiet {pblock_657_xz_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_657_xz_s}] }
create_pblock pblock_657_xz_s
set pblk [get_pblocks -quiet {pblock_657_xz_s}]
