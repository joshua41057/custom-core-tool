# pblock for 511.povray_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_511_povray_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_511_povray_r}] }
create_pblock pblock_511_povray_r
set pblk [get_pblocks -quiet {pblock_511_povray_r}]
