# pblock for 523.xalancbmk_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_523_xalancbmk_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_523_xalancbmk_r}] }
create_pblock pblock_523_xalancbmk_r
set pblk [get_pblocks -quiet {pblock_523_xalancbmk_r}]
