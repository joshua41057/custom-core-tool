# pblock for 649.fotonik3d_s  CR: X0Y0 .. X2Y3  (sumSLICE=20760, sumSLICEM~10380)
if {[llength [get_pblocks -quiet {pblock_649_fotonik3d_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_649_fotonik3d_s}] }
create_pblock pblock_649_fotonik3d_s
set pblk [get_pblocks -quiet {pblock_649_fotonik3d_s}]
...
set _cr_list {X0Y0 X0Y1 X0Y2 X0Y3 X1Y0 X1Y1 X1Y2 X1Y3 X2Y0 X2Y1 X2Y2 X2Y3}
