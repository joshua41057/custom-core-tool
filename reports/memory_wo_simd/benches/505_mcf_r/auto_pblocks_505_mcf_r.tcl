# pblock for 505.mcf_r  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_505_mcf_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_505_mcf_r}] }
create_pblock pblock_505_mcf_r
set pblk [get_pblocks -quiet {pblock_505_mcf_r}]
