# pblock for 549.fotonik3d_r  CR: X0Y0 .. X3Y3  (sumSLICE=26400, sumSLICEM~13200)
if {[llength [get_pblocks -quiet {pblock_549_fotonik3d_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_549_fotonik3d_r}] }
create_pblock pblock_549_fotonik3d_r
set pblk [get_pblocks -quiet {pblock_549_fotonik3d_r}]
...
set _cr_list {X0Y0 X0Y1 X0Y2 X0Y3 X1Y0 X1Y1 X1Y2 X1Y3 X2Y0 X2Y1 X2Y2 X2Y3 X3Y0 X3Y1 X3Y2 X3Y3}
