# pblock for 641.leela_s  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_641_leela_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_641_leela_s}] }
create_pblock pblock_641_leela_s
set pblk [get_pblocks -quiet {pblock_641_leela_s}]
