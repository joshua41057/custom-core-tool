# pblock for 520.omnetpp_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_520_omnetpp_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_520_omnetpp_r}] }
create_pblock pblock_520_omnetpp_r
set pblk [get_pblocks -quiet {pblock_520_omnetpp_r}]
