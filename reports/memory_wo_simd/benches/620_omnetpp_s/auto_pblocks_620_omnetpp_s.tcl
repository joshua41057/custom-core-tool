# pblock for 620.omnetpp_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_620_omnetpp_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_620_omnetpp_s}] }
create_pblock pblock_620_omnetpp_s
set pblk [get_pblocks -quiet {pblock_620_omnetpp_s}]
