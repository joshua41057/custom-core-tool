# pblock for 503.bwaves_r  CR: X0Y0 .. X2Y3  (sumSLICE=20760, sumSLICEM~10380)
if {[llength [get_pblocks -quiet {pblock_503_bwaves_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_503_bwaves_r}] }
create_pblock pblock_503_bwaves_r
set pblk [get_pblocks -quiet {pblock_503_bwaves_r}]
