# pblock for 654.roms_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_654_roms_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_654_roms_s}] }
create_pblock pblock_654_roms_s
set pblk [get_pblocks -quiet {pblock_654_roms_s}]
