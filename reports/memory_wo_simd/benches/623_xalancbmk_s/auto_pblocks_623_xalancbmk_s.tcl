# pblock for 623.xalancbmk_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_623_xalancbmk_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_623_xalancbmk_s}] }
create_pblock pblock_623_xalancbmk_s
set pblk [get_pblocks -quiet {pblock_623_xalancbmk_s}]
