# pblock for 603.bwaves_s  CR: X0Y0 .. X1Y2  (sumSLICE=9660, sumSLICEM~4830)
if {[llength [get_pblocks -quiet {pblock_603_bwaves_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_603_bwaves_s}] }
create_pblock pblock_603_bwaves_s
set pblk [get_pblocks -quiet {pblock_603_bwaves_s}]
