# pblock for 526.blender_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_526_blender_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_526_blender_r}] }
create_pblock pblock_526_blender_r
set pblk [get_pblocks -quiet {pblock_526_blender_r}]
