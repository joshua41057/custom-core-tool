# pblock for 502.gcc_r  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_502_gcc_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_502_gcc_r}] }
create_pblock pblock_502_gcc_r
set pblk [get_pblocks -quiet {pblock_502_gcc_r}]
