# pblock for 525.x264_r  CR: X0Y0 .. X2Y2  (sumSLICE=15480, sumSLICEM~7740)
if {[llength [get_pblocks -quiet {pblock_525_x264_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_525_x264_r}] }
create_pblock pblock_525_x264_r
set pblk [get_pblocks -quiet {pblock_525_x264_r}]
...
set _cr_list {X0Y0 X0Y1 X0Y2 X1Y0 X1Y1 X1Y2 X2Y0 X2Y1 X2Y2}
