# pblock for 600.perlbench_s  CR: X0Y0 .. X1Y2  (sumSLICE=9660, sumSLICEM~4830)
if {[llength [get_pblocks -quiet {pblock_600_perlbench_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_600_perlbench_s}] }
create_pblock pblock_600_perlbench_s
set pblk [get_pblocks -quiet {pblock_600_perlbench_s}]
...
set _cr_list {X0Y0 X0Y1 X0Y2 X1Y0 X1Y1 X1Y2}
