# pblock for 628.pop2_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_628_pop2_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_628_pop2_s}] }
create_pblock pblock_628_pop2_s
set pblk [get_pblocks -quiet {pblock_628_pop2_s}]
