# pblock for 527.cam4_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_527_cam4_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_527_cam4_r}] }
create_pblock pblock_527_cam4_r
set pblk [get_pblocks -quiet {pblock_527_cam4_r}]
