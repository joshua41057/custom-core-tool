# pblock for 548.exchange2_r  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_548_exchange2_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_548_exchange2_r}] }
create_pblock pblock_548_exchange2_r
set pblk [get_pblocks -quiet {pblock_548_exchange2_r}]
