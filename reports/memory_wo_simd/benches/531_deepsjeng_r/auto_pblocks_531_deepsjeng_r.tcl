# pblock for 531.deepsjeng_r  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_531_deepsjeng_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_531_deepsjeng_r}] }
create_pblock pblock_531_deepsjeng_r
set pblk [get_pblocks -quiet {pblock_531_deepsjeng_r}]
