# pblock for 557.xz_r  CR: X0Y0 .. X2Y2  (sumSLICE=15480, sumSLICEM~7740)
if {[llength [get_pblocks -quiet {pblock_557_xz_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_557_xz_r}] }
create_pblock pblock_557_xz_r
set pblk [get_pblocks -quiet {pblock_557_xz_r}]
