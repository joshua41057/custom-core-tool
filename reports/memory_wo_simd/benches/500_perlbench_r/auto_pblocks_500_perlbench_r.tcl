# pblock for 500.perlbench_r  CR: X0Y0 .. X1Y2  (sumSLICE=9660, sumSLICEM~4830)
if {[llength [get_pblocks -quiet {pblock_500_perlbench_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_500_perlbench_r}] }
create_pblock pblock_500_perlbench_r
set pblk [get_pblocks -quiet {pblock_500_perlbench_r}]
