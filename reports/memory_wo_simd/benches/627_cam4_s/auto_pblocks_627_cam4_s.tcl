# pblock for 627.cam4_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_627_cam4_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_627_cam4_s}] }
create_pblock pblock_627_cam4_s
set pblk [get_pblocks -quiet {pblock_627_cam4_s}]
