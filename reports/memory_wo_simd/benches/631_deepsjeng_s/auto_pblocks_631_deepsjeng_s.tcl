# pblock for 631.deepsjeng_s  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_631_deepsjeng_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_631_deepsjeng_s}] }
create_pblock pblock_631_deepsjeng_s
set pblk [get_pblocks -quiet {pblock_631_deepsjeng_s}]
