# pblock for 621.wrf_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_621_wrf_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_621_wrf_s}] }
create_pblock pblock_621_wrf_s
set pblk [get_pblocks -quiet {pblock_621_wrf_s}]
