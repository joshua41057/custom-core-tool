# pblock for 648.exchange2_s  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_648_exchange2_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_648_exchange2_s}] }
create_pblock pblock_648_exchange2_s
set pblk [get_pblocks -quiet {pblock_648_exchange2_s}]
...
set _cr_list {X0Y0 X0Y1 X1Y0 X1Y1}
