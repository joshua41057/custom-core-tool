# pblock for 619.lbm_s  CR: X0Y0 .. X1Y1  (sumSLICE=6360, sumSLICEM~3180)
if {[llength [get_pblocks -quiet {pblock_619_lbm_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_619_lbm_s}] }
create_pblock pblock_619_lbm_s
set pblk [get_pblocks -quiet {pblock_619_lbm_s}]
