# pblock for 538.imagick_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_538_imagick_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_538_imagick_r}] }
create_pblock pblock_538_imagick_r
set pblk [get_pblocks -quiet {pblock_538_imagick_r}]
