# pblock for 544.nab_r  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_544_nab_r}]]} { delete_pblocks [get_pblocks -quiet {pblock_544_nab_r}] }
create_pblock pblock_544_nab_r
set pblk [get_pblocks -quiet {pblock_544_nab_r}]
