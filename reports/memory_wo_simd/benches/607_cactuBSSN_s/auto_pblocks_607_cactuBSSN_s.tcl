# pblock for 607.cactuBSSN_s  CR: X0Y0 .. X0Y0  (sumSLICE=1740, sumSLICEM~870)
if {[llength [get_pblocks -quiet {pblock_607_cactuBSSN_s}]]} { delete_pblocks [get_pblocks -quiet {pblock_607_cactuBSSN_s}] }
create_pblock pblock_607_cactuBSSN_s
set pblk [get_pblocks -quiet {pblock_607_cactuBSSN_s}]
