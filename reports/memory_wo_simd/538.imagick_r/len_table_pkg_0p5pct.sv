package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    '{ OP_LEA, OP_MOVZX, OP_NOP },
    '{ OP_MOV, OP_IMUL, OP_MOV },
    '{ OP_MOV, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_CDQE, OP_NOP },
    '{ OP_LEA, OP_MOVZX, OP_NOP },
    '{ OP_MOVSX, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_MOV },
    '{ OP_MOV, OP_SUB, OP_ADD },
    '{ OP_CMP, OP_SETNZ, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP },
    '{ OP_LEA, OP_CMP, OP_SETZ },
    '{ OP_MOVZX, OP_MOV, OP_NOP },
