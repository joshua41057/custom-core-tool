...
set hc [get_cells -quiet top_bench__500_perlbench_r/u_500_perlbench_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__500_perlbench_r/u_500_perlbench_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
