...
set hc [get_cells -quiet top_bench__541_leela_r/u_541_leela_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__541_leela_r/u_541_leela_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
