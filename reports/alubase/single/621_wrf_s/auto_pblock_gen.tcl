...
set hc [get_cells -quiet top_bench__621_wrf_s/u_621_wrf_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__621_wrf_s/u_621_wrf_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
