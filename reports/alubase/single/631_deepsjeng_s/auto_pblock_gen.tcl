...
resize_pblock $pblk -add {SLICE_X142Y840:SLICE_X153Y899}
set hc [get_cells -quiet top_bench__631_deepsjeng_s/u_631_deepsjeng_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__631_deepsjeng_s/u_631_deepsjeng_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
