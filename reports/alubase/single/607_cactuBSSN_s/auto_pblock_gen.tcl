...
set hc [get_cells -quiet top_bench__607_cactuBSSN_s/u_607_cactuBSSN_s]
if {![llength $hc]} { set tail [lindex [split "top_bench__607_cactuBSSN_s/u_607_cactuBSSN_s" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
