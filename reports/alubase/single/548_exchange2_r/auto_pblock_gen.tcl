...
set hc [get_cells -quiet top_bench__548_exchange2_r/u_548_exchange2_r]
if {![llength $hc]} { set tail [lindex [split "top_bench__548_exchange2_r/u_548_exchange2_r" "/"] end]; set hc [get_cells -quiet -hier -regexp [format {(^|.*/)%s(/|$)} $tail]] }
