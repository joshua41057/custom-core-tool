package len_table_pkg;
  ...
  localparam op_t OPS_LUT [N_CASE][MAX_LEN] = '{
    '{ OP_ADD, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_ADD, OP_NOP },
    '{ OP_MOV, OP_SUB, OP_NOP },
    '{ OP_MOV, OP_MUL, OP_NOP },
    '{ OP_SHR, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_ADD },
    '{ OP_MOV, OP_MOV, OP_NOP },
    ...
    '{ OP_LEA, OP_MOV, OP_NOP },
    '{ OP_LEA, OP_MOV, OP_NOP },
    '{ OP_ADD, OP_SUB, OP_NOP },
    '{ OP_MOVSX, OP_MOV, OP_NOP },
    '{ OP_LEA, OP_SUB, OP_NOP },
    '{ OP_MOV, OP_MOV, OP_NOP }
  };
  ...
  localparam logic [31:0] IMM_LUT [N_CASE][MAX_LEN] = '{
    '{ 32'h00000030, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000003, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00001000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    ...
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000010, 32'h00000008, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 },
    '{ 32'h00000000, 32'h00000000, 32'h00000000 }
  };
